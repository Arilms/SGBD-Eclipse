...
public class Main {
	public static void main(String args[]) {
		 ...
		 * eu irei deixar uma sugestão no seu discord, deixei comentado agora identificando em cada classe,
		 * qual será a chave primaria no banco de dados e a chave estrangeira, ficou basico assim, pois,
		 * eu não sei como seria a relação do arquivo java com o banco de dados no caso, posso ter me
